...
# SURGICAL DATA HEATMAP - ADDING SOUTH-SIDE DISTRESS POCKETS
...
danger_pockets = [
    ...
    # NEW: South-East Distress (East of 4th, South of Grand)
    {"lat": 35.0400, "lng": -97.9250, "strength": 0.014, "weight": 0.9}, 
    # NEW: South-Central Pocket (Older rentals/distress)
    {"lat": 35.0380, "lng": -97.9450, "strength": 0.008, "weight": 0.5},
]
safe_anchors = [
    {"lat": 35.0340, "lng": -97.9580, "strength": 0.015, "weight": 1.0}, # S.West Elite (Tightened)
    {"lat": 35.0350, "lng": -97.9480, "strength": 0.008, "weight": 0.7}, # USAO Anchor (Tightened)
]
...
for r in range(grid_res):
    for c in range(grid_res):
        ...
        # 1. Neutral Yellow baseline
        r_val, g_val, b_val = 255, 255, 0
        
        # 2. Apply Latitude Gradient (General North=Red, South=Green)
        ...
        # 3. Apply Danger Point Influence (Forcing Red even in the South)
        ...
        # 4. Apply Safe Anchor Influence (Forcing Green)
...
# HUD
draw.rectangle([50, 50, 700, 380], fill=(0,0,0,250), outline='white', width=4)
draw.text((80, 70), "BRASH TACTICAL COMMAND - CHICKASHA V9 (POCKETS)", fill='white')
draw.line([80, 100, 670, 100], fill='white', width=2)

y_pos = 120
legend = [
    ("#00FF00", "ELITE: S.West Alpha / Pioneer Zone"),
    ("#FFFF00", "TRANSITIONAL: Stable Mid-Market"),
    ("#FFA500", "SPECULATIVE: Block-by-Block Risk"),
    ("#FF0000", "CRITICAL RISK: Industrial / Distress Pockets"),
    ("#00BFFF", "LANDMARK: University / Plant")
]
...
combined.save('/home/clawdbot/.openclaw/workspace/chickasha_tactical_v9_pockets.png')
print("V9 Pockets Map Rendered.")
